 ...
 * @author Άκης
 */
public class Pista01 extends Pista implements ActionListener {

   

    
    
    public Pista01(String name) {
        super(name);
    }
   ...
   public void board() {//συναρτηση για δημιουργια πιστας
        ...
        jF.setLayout(new GridLayout(5,10));//εφαρμοζουμε το GridLayout
        ...
        for (int i = 0; i < boardList2.size(); i++) {//για τις γραμμες της ArrayList
            ...
            for (int j = 0; j < boardList2.get(i).size(); j++) {//για το στοιχειο καθε γραμμης
                ...
                jB = new JButton(boardList2.get(i).get(j), new ImageIcon("m1.png"));
                ...
                jB = new JButton(boardList2.get(i).get(j), new ImageIcon("k1.png"));
                ...
                jB = new JButton(boardList2.get(i).get(j), new ImageIcon("l1.png"));
                ...
                jB = new JButton(boardList2.get(i).get(j), new ImageIcon("E1.png"));
        ...
        for (int r = 0; r < a1.size(); r++) {//για καθε γραμμη της a1
            ...
            for (int c = 0; c < a1.get(r).size(); c++) {//για καθε στοιχειο της γραμμης
                ...
                if (!(a1.get(r).get(c).getText().equals(" "))) {//αν τα πλακιδια δεν ειναι κενα
                    if ((c == 0) || (c == getBoardList().get(r).size()) || (c == 0) || (c == 29)) {//θεσεις που τα πλακιδια παντα ειναι ελευθερα
