 ...
 * @author Άκης
 */
public class Pista04 extends Pista implements ActionListener {//οι κλασεις Pista01,Pista02,Pista03,Pista04 κληρονομουν τις συναρτησεις της κλασης Pista

   
    

    public Pista04(String name) {
        super(name);
    }
